        ...
        let scriptPubKeyTestVector = [
            ...
            (
                given: (
                    ...
                    scriptTree: ScriptTree?.some(.leaf(192, [Op](Data(hex: "20d85a959b0290bf19bb89ed43c916be835475d013da4b362117393e25a48229b8ac"))))
                ),
                intermediary: (
                    leafHashes: [
            ...
            (
                given: (
                    ...
                    scriptTree:  ScriptTree?.some(.leaf(192, [Op](Data(hex: "20b617298552a72ade070667e86ca63b8f5789a9fe8731ef91202a91c9f3459007ac"))))
                ),
                intermediary: (
                    leafHashes: [
            ...
            (
                given: (
                    ...
                    scriptTree: ScriptTree?.some(.branch(
                        .leaf(192, [Op](Data(hex: "20387671353e273264c495656e27e39ba899ea8fee3bb69fb2a680e22093447d48ac"))),
                        .leaf(250, [Op](Data(hex: "06424950333431")))
                    ))
                ),
                intermediary: (
                    leafHashes: [
            ...
            (
                given: (
                    ...
                    scriptTree: ScriptTree?.some(.branch(
                        .leaf(192, [Op](Data(hex: "2044b178d64c32c4a05cc4f4d1407268f764c940d20ce97abfd44db5c3592b72fdac"))),
                        .leaf(192, [Op](Data(hex: "07546170726f6f74")))
                    ))
                ),
                intermediary: (
                    leafHashes: [
            ...
            (
                given: (
                    ...
                    scriptTree: ScriptTree?.some(.branch(
                        .leaf(192, [Op](Data(hex: "2072ea6adcf1d371dea8fba1035a09f3d24ed5a059799bae114084130ee5898e69ac"))),
                        .branch(
                            .leaf(192, [Op](Data(hex: "202352d137f2f3ab38d1eaa976758873377fa5ebb817372c71e2c542313d4abda8ac"))),
                            .leaf(192, [Op](Data(hex: "207337c0dd4253cb86f2c43a2351aadd82cccb12a172cd120452b9bb8324f2186aac")))
                        )
                    ))
                ),
                intermediary: (
            ...
            (
                given: (
                    ...
                    scriptTree: ScriptTree?.some(.branch(
                        .leaf(192, [Op](Data(hex: "2071981521ad9fc9036687364118fb6ccd2035b96a423c59c5430e98310a11abe2ac"))),
                        .branch(
                            .leaf(192, [Op](Data(hex: "20d5094d2dbe9b76e2c245a2b89b6006888952e2faa6a149ae318d69e520617748ac"))),
                            .leaf(192, [Op](Data(hex: "20c440b462ad48c7a77f94cd4532d8f2119dcebbd7c9764557e62726419b08ad4cac")))
                        )
                    ))
                ),
                intermediary: (
