...
final class BTransactionBCoreTransactionTests: XCTestCase {
    ...
    func testOutputs() throws {
        ...
        XCTAssertEqual(output.scriptPubKey.data(includeLength: false).hex, bCoreOutput.scriptPubKey.hex)
        ...
        XCTAssertEqual(output2.scriptPubKey.data(includeLength: false).hex, bCoreOutput2.scriptPubKey.hex)
    }
