...
final class HashTests: XCTestCase {
    ...
    func testHashData() {
        ...
        let sigMsg = tx.sigMsgV0(sigHashType: .all, inIdx: 1, scriptCode: .init(Data(hex: "1976a9141d0f172a0ecb48aee1be1f2687d2963ae33f71a188ac")), amount: 600_000_000)
    ...
    func testTxSignature() {
        ...
        let signed1 = tx.signInput(privKey: privKey1, pubKey: pubKey1, sigHashType: .all, inIdx: 1, prevOuts: prevOuts)
        ...
        let signed = signed1.signInput(privKey: privKey0, pubKey: pubKey0, sigHashType: .all, inIdx: 0, prevOuts: prevOuts)
