...
final class HashTests: XCTestCase {
    ...
    func testTxSignature() {
        ...
        var signed1 = tx.signInput(privKey: privKey1, pubKey: pubKey1, hashType: .all, inIdx: 1, prevOuts: prevOuts)
        ...
        let signed = signed1.signInput(privKey: privKey0, pubKey: pubKey0, hashType: .all, inIdx: 0, prevOuts: prevOuts)
