...
final class HashTests: XCTestCase {
    ...
    func testTxSignature() {
        ...
        let signed1 = tx.sign(privKey: privKey1, pubKey: pubKey1, inIdx: 1, prevOuts: prevOuts, sigHashType: .all)
        ...
        let signed = signed1.sign(privKey: privKey0, pubKey: pubKey0, inIdx: 0, prevOuts: prevOuts, sigHashType: .all)
