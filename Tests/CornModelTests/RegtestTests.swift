...
final class RegtestTests: XCTestCase {
    ...
    func testLegacy_pyBitcoin_all() {
        ...
        let signedTx = unsignedTx.signed(privKey: privKey0, pubKey: pubKey0, redeemScript: .none, inIdx: 0, prevOuts: prevOuts, sigHashType: .all)
    ...
    func testLegacy_pyBitcoin2_none() {
        ...
        let signedTx = unsignedTx.signed(privKey: privKey0, pubKey: pubKey0, redeemScript: .none, inIdx: 0, prevOuts: prevOuts, sigHashType: .none)
    ...
    func testLegacy_pyBitcoin2x2_all() {
        ...
        let signedTx0 = unsignedTx.signed(privKey: privKey0, pubKey: pubKey0, redeemScript: .none, inIdx: 0, prevOuts: prevOuts, sigHashType: .all)
        ...
        let signedTx = signedTx0.signed(privKey: privKey1, pubKey: pubKey1, redeemScript: .none, inIdx: 1, prevOuts: prevOuts, sigHashType: .all)
    ...
    func testLegacy_pyBitcoin2x2_none() {
        ...
        let signedTx0 = unsignedTx.signed(privKey: privKey0, pubKey: pubKey0, redeemScript: .none, inIdx: 0, prevOuts: prevOuts, sigHashType: .none)
        ...
        let signedTx = signedTx0.signed(privKey: privKey1, pubKey: pubKey1, redeemScript: .none, inIdx: 1, prevOuts: prevOuts, sigHashType: .none)
    ...
    func testLegacy_1to1_all() {
        ...
        let sig = sign(msg: sigHash, privKey: privKey0)
        XCTAssertTrue(unsignedTx.checkSigLegacy(sig + SigHashType.all.data, privKey: privKey0, inIdx: 0, prevOut: prevOut0, redeemScript: .none))
        ...
        if case .pushBytes(let sigWithHashType) = coreOp {
            XCTAssertTrue(unsignedTx.checkSigLegacy(sigWithHashType, privKey: privKey0, inIdx: 0, prevOut: prevOut0, redeemScript: .none))
        } else {
            XCTFail("Could not extract signature from transaction.")
        }

        // let signedTx = unsignedTx.signed(privKey: privKey0, pubKey: pubKey0, redeemScript: .none, inIdx: 0, prevOut: prevOut0, sigHashType: .all)
    ...
    func testLegacy_1to1_allAny() {
        ...
        let signedTx = unsignedTx.signed(privKey: privKey0, pubKey: pubKey0, redeemScript: .none, inIdx: 0, prevOuts: prevOuts, sigHashType: .allAnyCanPay)
    ...
    func testLegacy_1to1_noneAny() {
        ...
        let signedTx = unsignedTx.signed(privKey: privKey0, pubKey: pubKey0, redeemScript: .none, inIdx: 0, prevOuts: prevOuts, sigHashType: .noneAnyCanPay)
    ...
    func testLegacy_1to1_single() {
        ...
        let signedTx = unsignedTx.signed(privKey: privKey0, pubKey: pubKey0, redeemScript: .none, inIdx: 0, prevOuts: prevOuts, sigHashType: .single)
    ...
    func testLegacy_1to1_singleAny() {
        ...
        let signedTx = unsignedTx.signed(privKey: privKey0, pubKey: pubKey0, redeemScript: .none, inIdx: 0, prevOuts: prevOuts, sigHashType: .singleAnyCanPay)
