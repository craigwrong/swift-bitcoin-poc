...
final class RegtestTests: XCTestCase {
    ...
    func testLegacy_pyBitcoin_all() {
        ...
        let prevOuts = [Tx.Out(value: UInt64(0), scriptPubKey: .init(ops: [
            .dup,
            .hash160,
        ...
        let signedTx = unsignedTx.signed(secretKey: secretKey0, pubKey: pubKey0, redeemScript: .none, inIdx: 0, prevOuts: prevOuts, sigHashType: .all)
    ...
    func testLegacy_pyBitcoin2_all() {
        ...
        let sigMsg = unsignedTx.sigMsgLegacy(inIdx: 0, scriptCode: prevOuts[0].scriptPubKey, sigHashType: .all)
    ...
    func testLegacy_pyBitcoin2_none() {
        ...
        let secretKey0 = Data(hex: "81c70e36ffa5e3e6425dc19c7c35315d3d72dc60b79cb78fe009a335de29dd2201") // cRvyLwCPLU88jsyj94L7iJjQX5C2f8koG4G2gevN4BeSGcEvfKe9
        let pubKey0 = Data(hex: "03a2fef1829e0742b89c218c51898d9e7cb9d51201ba2bf9d9e9214ebb6af32708")
        let sigMsg = unsignedTx.sigMsgLegacy(inIdx: 0, scriptCode: prevOuts[0].scriptPubKey, sigHashType: .none)
        ...
        let signedTx = unsignedTx.signed(secretKey: secretKey0, pubKey: pubKey0, redeemScript: .none, inIdx: 0, prevOuts: prevOuts, sigHashType: .none)
    ...
    func testLegacy_pyBitcoin2x2_all() {
        ...
        let sigMsg0 = unsignedTx.sigMsgLegacy(inIdx: 0, scriptCode: prevOuts[0].scriptPubKey, sigHashType: .all)
        ...
        let signedTx0 = unsignedTx.signed(secretKey: secretKey0, pubKey: pubKey0, redeemScript: .none, inIdx: 0, prevOuts: prevOuts, sigHashType: .all)
        ...
        let sigMsg1 = unsignedTx.sigMsgLegacy(inIdx: 1, scriptCode: prevOuts[1].scriptPubKey, sigHashType: .all)
        ...
        let signedTx = signedTx0.signed(secretKey: secretKey1, pubKey: pubKey1, redeemScript: .none, inIdx: 1, prevOuts: prevOuts, sigHashType: .all)
    ...
    func testLegacy_pyBitcoin2x2_none() {
        ...
        let sigMsg0 = unsignedTx.sigMsgLegacy(inIdx: 0, scriptCode: prevOuts[0].scriptPubKey, sigHashType: .none)
        ...
        let signedTx0 = unsignedTx.signed(secretKey: secretKey0, pubKey: pubKey0, redeemScript: .none, inIdx: 0, prevOuts: prevOuts, sigHashType: .none)
        
        let secretKey1 = Data(hex: "f0ef687ea00a50936b659748b89a5b65dff8b3cea215d33f5d8c0917faab9c4301") // cVf3kGh6552jU2rLaKwXTKq5APHPoZqCP4GQzQirWGHFoHQ9rEVt
        let pubKey1 = Data(hex: "02364d6f04487a71b5966eae3e14a4dc6f00dbe8e55e61bedd0b880766bfe72b5d")
        
        let sigMsg1 = unsignedTx.sigMsgLegacy(inIdx: 1, scriptCode: prevOuts[1].scriptPubKey, sigHashType: .none)
        ...
        let signedTx = signedTx0.signed(secretKey: secretKey1, pubKey: pubKey1, redeemScript: .none, inIdx: 1, prevOuts: prevOuts, sigHashType: .none)
    ...
    func testLegacy_1to1_all() {
        ...
        let prevOut0 = Tx.Out(value: UInt64(0), scriptPubKey: .init(Data(hex: "76a914786890276a55f3e6d2f403e3d595b6603964fa0d88ac"), includesLength: false))
        ...
        let sigMsg = unsignedTx.sigMsgLegacy(inIdx: 0, scriptCode: prevOut0.scriptPubKey, sigHashType: .all)
        ...
        let sigHash = unsignedTx.sigHashLegacy(sigHashType: .all, inIdx: 0, prevOut: prevOut0, redeemScript: .none)
        let sig = sign(msg: sigHash, secretKey: secretKey0)
        XCTAssertTrue(unsignedTx.checkSigLegacy(sig + SigHashType.all.data, secretKey: secretKey0, inIdx: 0, prevOut: prevOut0, redeemScript: .none))
        ...
        if case .pushBytes(let sigWithHashType) = coreOp {
            XCTAssertTrue(unsignedTx.checkSigLegacy(sigWithHashType, secretKey: secretKey0, inIdx: 0, prevOut: prevOut0, redeemScript: .none))
        } else {
            XCTFail("Could not extract signature from transaction.")
        }

        // let signedTx = unsignedTx.signed(secretKey: secretKey0, pubKey: pubKey0, redeemScript: .none, inIdx: 0, prevOut: prevOut0, sigHashType: .all)
    ...
    func testLegacy_1to1_allAny() {
        ...
        let prevOuts = [
            Tx.Out(value: UInt64(0), scriptPubKey: .init(Data(hex: "76a914786890276a55f3e6d2f403e3d595b6603964fa0d88ac"), includesLength: false))
        ]
        let secretKey0 = Data(hex: "828748ccadd3792f39841749da9618389dcce35ace39d94b131ae8d8a359804c") // 92aQLXE8yvQ1qHoXvPCSSoLP3AM65g98Pavxsb53MTdTv1BgKXE
        ...
        let sigMsg = unsignedTx.sigMsgLegacy(inIdx: 0, scriptCode: prevOuts[0].scriptPubKey, sigHashType: .allAnyCanPay)
        ...
        let signedTx = unsignedTx.signed(secretKey: secretKey0, pubKey: pubKey0, redeemScript: .none, inIdx: 0, prevOuts: prevOuts, sigHashType: .allAnyCanPay)
    ...
    func testLegacy_1to1_noneAny() {
        ...
        let prevOuts = [Tx.Out(value: UInt64(0), scriptPubKey: .init(Data(hex: "76a914786890276a55f3e6d2f403e3d595b6603964fa0d88ac"), includesLength: false))]
        let secretKey0 = Data(hex: "828748ccadd3792f39841749da9618389dcce35ace39d94b131ae8d8a359804c") // 92aQLXE8yvQ1qHoXvPCSSoLP3AM65g98Pavxsb53MTdTv1BgKXE
        let pubKey0 = Data(hex: "04ce88102d2af294198df851e4776e4c505e2f288cb253a244f69fb0ddc656f11e1286fb9309a39a92553e2ce3969eeb92ed30bd402a7cbc62ec7d7a4e32f7c125")
        
        let sigMsg = unsignedTx.sigMsgLegacy(inIdx: 0, scriptCode: prevOuts[0].scriptPubKey, sigHashType: .noneAnyCanPay)
        ...
        let signedTx = unsignedTx.signed(secretKey: secretKey0, pubKey: pubKey0, redeemScript: .none, inIdx: 0, prevOuts: prevOuts, sigHashType: .noneAnyCanPay)
    ...
    func testLegacy_1to1_single() {
        ...
        let sigMsg = unsignedTx.sigMsgLegacy(inIdx: 0, scriptCode: prevOuts[0].scriptPubKey, sigHashType: .single)
        ...
        let signedTx = unsignedTx.signed(secretKey: secretKey0, pubKey: pubKey0, redeemScript: .none, inIdx: 0, prevOuts: prevOuts, sigHashType: .single)
    ...
    func testLegacy_1to1_singleAny() {
        ...
        let prevOuts = [Tx.Out(value: UInt64(312500000), scriptPubKey: .init(Data(hex: "76a914786890276a55f3e6d2f403e3d595b6603964fa0d88ac"), includesLength: false))]
        let secretKey0 = Data(hex: "828748ccadd3792f39841749da9618389dcce35ace39d94b131ae8d8a359804c") // 92aQLXE8yvQ1qHoXvPCSSoLP3AM65g98Pavxsb53MTdTv1BgKXE
        let pubKey0 = Data(hex: "04ce88102d2af294198df851e4776e4c505e2f288cb253a244f69fb0ddc656f11e1286fb9309a39a92553e2ce3969eeb92ed30bd402a7cbc62ec7d7a4e32f7c125")
        
        let sigMsg = unsignedTx.sigMsgLegacy(inIdx: 0, scriptCode: prevOuts[0].scriptPubKey, sigHashType: .singleAnyCanPay)
        ...
        let signedTx = unsignedTx.signed(secretKey: secretKey0, pubKey: pubKey0, redeemScript: .none, inIdx: 0, prevOuts: prevOuts, sigHashType: .singleAnyCanPay)
