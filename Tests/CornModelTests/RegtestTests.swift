...
final class RegtestTests: XCTestCase {
    ...
    func testLegacy_pyBitcoin_all() {
        ...
        tx.sign(privKeys: [privKey0], pubKeys: [pubKey0], hashType: .all, inIdx: 0, prevOuts: prevOuts)
    ...
    func testLegacy_pyBitcoin2_none() {
        ...
        tx.sign(privKeys: [privKey0], pubKeys: [pubKey0], hashType: SighashType.none, inIdx: 0, prevOuts: prevOuts)
    ...
    func testLegacy_pyBitcoin2x2_none() {
        ...
        tx.sign(privKeys: [privKey1], pubKeys: [pubKey1], hashType: SighashType.none, inIdx: 1, prevOuts: prevOuts)
    ...
    func testLegacy_1to1_all() {
        ...
        if let coreOp = ParsedScript(coreTx.inputs[0].script.data)?.operations.first, case .pushBytes(let hashType) = coreOp {
            XCTAssertTrue(tx.checkSignature(extendedSignature: hashType, publicKey: pubKey0, inputIndex: 0, previousOutput: prevOut0, scriptCode: prevOut0.script.data))
        } else {
            XCTFail("Could not extract signature from transaction.")
        }

        //tx.sign(privKeys: [privKey0], pubKeys: [pubKey0], inIdx: 0, prevOut: prevOut0, hashType: .all)
    ...
    func testLegacy_1to1_noneAny() {
        ...
        tx.sign(privKeys: [privKey0], pubKeys: [pubKey0], hashType: .noneAnyCanPay, inIdx: 0, prevOuts: prevOuts)
    ...
    func testLegacy_1to1_single() {
        ...
        tx.sign(privKeys: [privKey0], pubKeys: [pubKey0], hashType: .single, inIdx: 0, prevOuts: prevOuts)
