...
final class RegtestTests: XCTestCase {
    ...
    func testLegacy_pyBitcoin_all() {
        ...
        let secretKey0 = Data(hex: "81c70e36ffa5e3e6425dc19c7c35315d3d72dc60b79cb78fe009a335de29dd2201") // cRvyLwCPLU88jsyj94L7iJjQX5C2f8koG4G2gevN4BeSGcEvfKe9
        let publicKey0 = Data(hex: "03a2fef1829e0742b89c218c51898d9e7cb9d51201ba2bf9d9e9214ebb6af32708")
        
        tx.sign(secretKeys: [secretKey0], publicKeys: [publicKey0], sighashType: .all, inputIndex: 0, previousOutputs: previousOutputs)
        
        XCTAssertEqual(tx.data.hex, "")
    }
    ...
    func testLegacy_pyBitcoin2_all() {
        ...
        let sigMsg = tx.signatureMessage(sighashType: .all, inputIndex: 0, scriptCode: previousOutputs[0].script.data)
        ...
        XCTAssertEqual(tx.data.hex, "")
    }
    ...
    func testLegacy_pyBitcoin2_none() {
        ...
        let secretKey0 = Data(hex: "81c70e36ffa5e3e6425dc19c7c35315d3d72dc60b79cb78fe009a335de29dd2201") // cRvyLwCPLU88jsyj94L7iJjQX5C2f8koG4G2gevN4BeSGcEvfKe9
        let publicKey0 = Data(hex: "03a2fef1829e0742b89c218c51898d9e7cb9d51201ba2bf9d9e9214ebb6af32708")
        let sigMsg = tx.signatureMessage(sighashType: .none, inputIndex: 0, scriptCode: previousOutputs[0].script.data)
        ...
        tx.sign(secretKeys: [secretKey0], publicKeys: [publicKey0], sighashType: SighashType.none, inputIndex: 0, previousOutputs: previousOutputs)
    ...
    func testLegacy_pyBitcoin2x2_all() {
        ...
        let secretKey0 = Data(hex: "a67d3c308333c63f5e83a75e42a5533d0ac27153ecf443dd75cd4306d0c68fba01") // cTALNpTpRbbxTCJ2A5Vq88UxT44w1PE2cYqiB3n4hRvzyCev1Wwo
        let publicKey0 = Data(hex: "02d82c9860e36f15d7b72aa59e29347f951277c21cd4d34822acdeeadbcff8a546")
        
        let sigMsg0 = tx.signatureMessage(sighashType: .all, inputIndex: 0, scriptCode: previousOutputs[0].script.data)
        ...
        let secretKey1 = Data(hex: "f0ef687ea00a50936b659748b89a5b65dff8b3cea215d33f5d8c0917faab9c4301") // cVf3kGh6552jU2rLaKwXTKq5APHPoZqCP4GQzQirWGHFoHQ9rEVt
        let publicKey1 = Data(hex: "02364d6f04487a71b5966eae3e14a4dc6f00dbe8e55e61bedd0b880766bfe72b5d")
        
        let sigMsg1 = tx.signatureMessage(sighashType: .all, inputIndex: 1, scriptCode: previousOutputs[1].script.data)
        ...
        XCTAssertEqual(tx.data.hex, "")
    ...
    func testLegacy_pyBitcoin2x2_none() {
        ...
        let sigMsg0 = tx.signatureMessage(sighashType: .none, inputIndex: 0, scriptCode: previousOutputs[0].script.data)
        ...
        let sigMsg1 = tx.signatureMessage(sighashType: .none, inputIndex: 1, scriptCode: previousOutputs[1].script.data)
        ...
        tx.sign(secretKeys: [secretKey1], publicKeys: [publicKey1], sighashType: SighashType.none, inputIndex: 1, previousOutputs: previousOutputs)
        ...
        XCTAssertEqual(tx.data.hex, "")
    }
    ...
    func testLegacy_1to1_all() {
        ...
        let sigMsg = tx.signatureMessage(sighashType: .all, inputIndex: 0, scriptCode: previousOutput0.script.data)
        ...
        let sig = tx.createSignature(inputIndex: 0, secretKey: secretKey0, sighashType: .all, previousOutput: previousOutput0, scriptCode: previousOutput0.script.data)
        XCTAssertTrue(tx.checkSignature(extendedSignature: sig, publicKey: publicKey0, inputIndex: 0, previousOutput: previousOutput0, scriptCode: previousOutput0.script.data))
        ...
        let coreTx = Transaction(Data(hex: coreHex))
        if let coreOp = ParsedScript(coreTx.inputs[0].script.data)?.operations.first, case .pushBytes(let sighashType) = coreOp {
            XCTAssertTrue(tx.checkSignature(extendedSignature: sighashType, publicKey: publicKey0, inputIndex: 0, previousOutput: previousOutput0, scriptCode: previousOutput0.script.data))
        } else {
            XCTFail("Could not extract signature from transaction.")
        }

        //tx.sign(secretKeys: [secretKey0], publicKeys: [publicKey0], inputIndex: 0, previousOutput: previousOutput0, sighashType: .all)
    ...
    func testLegacy_1to1_allAny() {
        ...
        let sigMsg = tx.signatureMessage(sighashType: .allAnyCanPay, inputIndex: 0, scriptCode: previousOutputs[0].script.data)
    ...
    func testLegacy_1to1_none() {
        ...
        XCTAssertEqual(tx.data.hex, "")
    }
    ...
    func testLegacy_1to1_noneAny() {
        ...
        let sigMsg = tx.signatureMessage(sighashType: .noneAnyCanPay, inputIndex: 0, scriptCode: previousOutputs[0].script.data)
        ...
        tx.sign(secretKeys: [secretKey0], publicKeys: [publicKey0], sighashType: .noneAnyCanPay, inputIndex: 0, previousOutputs: previousOutputs)
    ...
    func testLegacy_1to1_single() {
        ...
        let sigMsg = tx.signatureMessage(sighashType: .single, inputIndex: 0, scriptCode: previousOutputs[0].script.data)
        ...
        tx.sign(secretKeys: [secretKey0], publicKeys: [publicKey0], sighashType: .single, inputIndex: 0, previousOutputs: previousOutputs)
    ...
    func testLegacy_1to1_singleAny() {
        ...
        let sigMsg = tx.signatureMessage(sighashType: .singleAnyCanPay, inputIndex: 0, scriptCode: previousOutputs[0].script.data)
