...
final class RegtestTests: XCTestCase {
    ...
    func testLegacy_pyBitcoin2_none() {
        ...
        tx.signInput(privKey: privKey0, pubKey: pubKey0, hashType: .none, inIdx: 0, prevOuts: prevOuts)
    ...
    func testLegacy_pyBitcoin2x2_none() {
        ...
        tx.signInput(privKey: privKey1, pubKey: pubKey1, hashType: .none, inIdx: 1, prevOuts: prevOuts)
