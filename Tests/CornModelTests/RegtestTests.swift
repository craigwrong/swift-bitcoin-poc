...
final class RegtestTests: XCTestCase {
    ...
    func testLegacy_pyBitcoin2x2_all() {
        ...
        var signedTx0 = unsignedTx.signInput(privKey: privKey0, pubKey: pubKey0, sigHashType: .all, inIdx: 0, prevOuts: prevOuts)
    ...
    func testLegacy_pyBitcoin2x2_none() {
        ...
        var signedTx0 = unsignedTx.signInput(privKey: privKey0, pubKey: pubKey0, sigHashType: .none, inIdx: 0, prevOuts: prevOuts)
