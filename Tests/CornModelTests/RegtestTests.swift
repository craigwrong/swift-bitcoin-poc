...
final class RegtestTests: XCTestCase {
    ...
    func testLegacy_pyBitcoin_all() {
        ...
        let signedTx = unsignedTx.signInput(privKey: privKey0, pubKey: pubKey0, sigHashType: .all, inIdx: 0, prevOuts: prevOuts)
    ...
    func testLegacy_pyBitcoin2_all() {
        ...
        let sigMsg = unsignedTx.sigMsg(sigHashType: .all, inIdx: 0, subScript: prevOuts[0].scriptPubKey)
    ...
    func testLegacy_pyBitcoin2_none() {
        ...
        let privKey0 = Data(hex: "81c70e36ffa5e3e6425dc19c7c35315d3d72dc60b79cb78fe009a335de29dd2201") // cRvyLwCPLU88jsyj94L7iJjQX5C2f8koG4G2gevN4BeSGcEvfKe9
        let pubKey0 = Data(hex: "03a2fef1829e0742b89c218c51898d9e7cb9d51201ba2bf9d9e9214ebb6af32708")
        let sigMsg = unsignedTx.sigMsg(sigHashType: .none, inIdx: 0, subScript: prevOuts[0].scriptPubKey)
        ...
        let signedTx = unsignedTx.signInput(privKey: privKey0, pubKey: pubKey0, sigHashType: .none, inIdx: 0, prevOuts: prevOuts)
    ...
    func testLegacy_pyBitcoin2x2_all() {
        ...
        let sigMsg0 = unsignedTx.sigMsg(sigHashType: .all, inIdx: 0, subScript: prevOuts[0].scriptPubKey)
        ...
        let signedTx0 = unsignedTx.signInput(privKey: privKey0, pubKey: pubKey0, sigHashType: .all, inIdx: 0, prevOuts: prevOuts)
        ...
        let sigMsg1 = unsignedTx.sigMsg(sigHashType: .all, inIdx: 1, subScript: prevOuts[1].scriptPubKey)
        ...
        let signedTx = signedTx0.signInput(privKey: privKey1, pubKey: pubKey1, sigHashType: .all, inIdx: 1, prevOuts: prevOuts)
    ...
    func testLegacy_pyBitcoin2x2_none() {
        ...
        let sigMsg0 = unsignedTx.sigMsg(sigHashType: .none, inIdx: 0, subScript: prevOuts[0].scriptPubKey)
        ...
        let signedTx0 = unsignedTx.signInput(privKey: privKey0, pubKey: pubKey0, sigHashType: .none, inIdx: 0, prevOuts: prevOuts)
        
        let privKey1 = Data(hex: "f0ef687ea00a50936b659748b89a5b65dff8b3cea215d33f5d8c0917faab9c4301") // cVf3kGh6552jU2rLaKwXTKq5APHPoZqCP4GQzQirWGHFoHQ9rEVt
        let pubKey1 = Data(hex: "02364d6f04487a71b5966eae3e14a4dc6f00dbe8e55e61bedd0b880766bfe72b5d")
        
        let sigMsg1 = unsignedTx.sigMsg(sigHashType: .none, inIdx: 1, subScript: prevOuts[1].scriptPubKey)
        ...
        let signedTx = signedTx0.signInput(privKey: privKey1, pubKey: pubKey1, sigHashType: .none, inIdx: 1, prevOuts: prevOuts)
    ...
    func testLegacy_1to1_all() {
        ...
        let sigMsg = unsignedTx.sigMsg(sigHashType: .all, inIdx: 0, subScript: prevOut0.scriptPubKey)
        ...
        XCTAssertTrue(unsignedTx.checkSig(sig + SigHashType.all.data, pubKey: pubKey0, inIdx: 0, prevOut: prevOut0, scriptCode: prevOut0.scriptPubKey, opIdx: 0))
        ...
        if case .pushBytes(let sigSigHashType) = coreOp {
            XCTAssertTrue(unsignedTx.checkSig(sigSigHashType, pubKey: pubKey0, inIdx: 0, prevOut: prevOut0, scriptCode: prevOut0.scriptPubKey, opIdx: 0))
        } else {
            XCTFail("Could not extract signature from transaction.")
        }

        // let signedTx = unsignedTx.signed(privKey: privKey0, pubKey: pubKey0, inIdx: 0, prevOut: prevOut0, sigHashType: .all)
    ...
    func testLegacy_1to1_allAny() {
        ...
        let sigMsg = unsignedTx.sigMsg(sigHashType: .allAnyCanPay, inIdx: 0, subScript: prevOuts[0].scriptPubKey)
        ...
        let signedTx = unsignedTx.signInput(privKey: privKey0, pubKey: pubKey0, sigHashType: .allAnyCanPay, inIdx: 0, prevOuts: prevOuts)
    ...
    func testLegacy_1to1_noneAny() {
        ...
        let sigMsg = unsignedTx.sigMsg(sigHashType: .noneAnyCanPay, inIdx: 0, subScript: prevOuts[0].scriptPubKey)
        ...
        let signedTx = unsignedTx.signInput(privKey: privKey0, pubKey: pubKey0, sigHashType: .noneAnyCanPay, inIdx: 0, prevOuts: prevOuts)
    ...
    func testLegacy_1to1_single() {
        ...
        let sigMsg = unsignedTx.sigMsg(sigHashType: .single, inIdx: 0, subScript: prevOuts[0].scriptPubKey)
        ...
        let signedTx = unsignedTx.signInput(privKey: privKey0, pubKey: pubKey0, sigHashType: .single, inIdx: 0, prevOuts: prevOuts)
    ...
    func testLegacy_1to1_singleAny() {
        ...
        let sigMsg = unsignedTx.sigMsg(sigHashType: .singleAnyCanPay, inIdx: 0, subScript: prevOuts[0].scriptPubKey)
        ...
        let signedTx = unsignedTx.signInput(privKey: privKey0, pubKey: pubKey0, sigHashType: .singleAnyCanPay, inIdx: 0, prevOuts: prevOuts)
