...
final class BIP143Tests: XCTestCase {
    ...
    func testP2SHP2WPKH() {
        ...
        let prevOut0 = Transaction.Output(value: 1_000_000_000, scriptData: Data(hex: "a9144733f37cf4db86fbc2efed2500b4f4e49f31202387"))
        ...
        tx.sign(privKeys: [privKey0], pubKeys: [pubKey0], redeemScript: redeemScript0, hashType: .all, inIdx: 0, prevOuts: [prevOut0])
