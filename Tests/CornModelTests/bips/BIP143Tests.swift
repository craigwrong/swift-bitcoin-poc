...
final class BIP143Tests: XCTestCase {
    ...
    func testP2SHP2WPKH() {
        ...
        let previousOutput0 = Transaction.Output(value: 1_000_000_000, script: .init(Data(hex: "a9144733f37cf4db86fbc2efed2500b4f4e49f31202387")))
        let redeemScript0 = ParsedScript(Data(hex: "001479091972186c449eb1ded22b78e40d009bdf0089"))
        ...
        tx.sign(secretKeys: [secretKey0], publicKeys: [publicKey0], redeemScript: redeemScript0, sighashType: .all, inputIndex: 0, previousOutputs: [previousOutput0])
