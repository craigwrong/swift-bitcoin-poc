...
final class BIP341Tests: XCTestCase {
    ...
    func testKeyPathSpending() {
        ...
        let utxosSpent = [
            ...
            Output(value: 462000000, script: .init(Data(hex: "5120147c9c57132f6e7ecddba9800bb0c4449251c92a1e60371ee77557b6620f3ea3"))),
            Output(value: 294000000, script: .init(Data(hex: "76a914751e76e8199196d454941c45d1b3a323f1433bd688ac"))),
            Output(value: 504000000, script: .init(Data(hex: "5120e4d810fd50586274face62b8a807eb9719cef49c04177cc6b76a9a4251d5450e"))),
            Output(value: 630000000, script: .init(Data(hex: "512091b64d5324723a985170e4dc5a0f84c041804f2cd12660fa5dec09fc21783605"))),
            Output(value: 378000000, script: .init(Data(hex: "00147dd65592d0ab2fe0d0257d571abf032cd9db93dc"))),
            Output(value: 672000000, script: .init(Data(hex: "512075169f4001aa68f15bbed28b218df1d0a62cbbcf1188c6665110c293c907b831"))),
            Output(value: 546000000, script: .init(Data(hex: "5120712447206d7a5238acc7ff53fbe94a3b64539ad291c7cdbc490b7577e4b17df5"))),
            Output(value: 588000000, script: .init(Data(hex: "512077e30a5522dd9f894c3f8b8bd4c4b2cf82ca7da8a3ea6a239655c39c050ab220")))
        ]
