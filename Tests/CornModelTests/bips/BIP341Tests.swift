...
final class BIP341Tests: XCTestCase {
    ...
    func testScriptPubKey() {
        let scriptPubKeyTestVector = [
            ...
            (
                given: (
                    ...
                    scriptTree: .leaf(192, [Op](Data(hex: "20d85a959b0290bf19bb89ed43c916be835475d013da4b362117393e25a48229b8ac"), version: .witnessV1))
                ),
                intermediary: (
                    leafHashes: [
            ...
            (
                given: (
                    ...
                    scriptTree:  ScriptTree?.some(.leaf(192, [Op](Data(hex: "20b617298552a72ade070667e86ca63b8f5789a9fe8731ef91202a91c9f3459007ac"), version: .witnessV1)))
                ),
                intermediary: (
                    leafHashes: [
            ...
            (
                given: (
                    ...
                    scriptTree: ScriptTree?.some(.branch(
                        .leaf(192, [Op](Data(hex: "20387671353e273264c495656e27e39ba899ea8fee3bb69fb2a680e22093447d48ac"), version: .witnessV1)),
                        .leaf(250, [Op](Data(hex: "06424950333431"), version: .witnessV1))
                    ))
                ),
                intermediary: (
                    leafHashes: [
            ...
            (
                given: (
                    ...
                    scriptTree: ScriptTree?.some(.branch(
                        .leaf(192, [Op](Data(hex: "2044b178d64c32c4a05cc4f4d1407268f764c940d20ce97abfd44db5c3592b72fdac"), version: .witnessV1)),
                        .leaf(192, [Op](Data(hex: "07546170726f6f74"), version: .witnessV1))
                    ))
                ),
                intermediary: (
                    leafHashes: [
            ...
            (
                given: (
                    ...
                    scriptTree: ScriptTree?.some(.branch(
                        .leaf(192, [Op](Data(hex: "2072ea6adcf1d371dea8fba1035a09f3d24ed5a059799bae114084130ee5898e69ac"), version: .witnessV1)),
                        .branch(
                            .leaf(192, [Op](Data(hex: "202352d137f2f3ab38d1eaa976758873377fa5ebb817372c71e2c542313d4abda8ac"), version: .witnessV1)),
                            .leaf(192, [Op](Data(hex: "207337c0dd4253cb86f2c43a2351aadd82cccb12a172cd120452b9bb8324f2186aac"), version: .witnessV1))
                        )
                    ))
                ),
                intermediary: (
            ...
            (
                given: (
                    ...
                    scriptTree: ScriptTree?.some(.branch(
                        .leaf(192, [Op](Data(hex: "2071981521ad9fc9036687364118fb6ccd2035b96a423c59c5430e98310a11abe2ac"), version: .witnessV1)),
                        .branch(
                            .leaf(192, [Op](Data(hex: "20d5094d2dbe9b76e2c245a2b89b6006888952e2faa6a149ae318d69e520617748ac"), version: .witnessV1)),
                            .leaf(192, [Op](Data(hex: "20c440b462ad48c7a77f94cd4532d8f2119dcebbd7c9764557e62726419b08ad4cac"), version: .witnessV1))
                        )
                    ))
                ),
                intermediary: (
        ...
        for i in scriptPubKeyTestVector.indices {
            ...
            let scriptPubKey = [Op.constant(1), .pushBytes(tweakedPubkey)].data
    ...
    func testKeyPathSpending() {
        ...
        let utxosSpent = [
            ...
            Tx.Out(value: 462000000, scriptPubKeyData: Data(hex: "5120147c9c57132f6e7ecddba9800bb0c4449251c92a1e60371ee77557b6620f3ea3")),
            Tx.Out(value: 294000000, scriptPubKeyData: Data(hex: "76a914751e76e8199196d454941c45d1b3a323f1433bd688ac")),
            Tx.Out(value: 504000000, scriptPubKeyData: Data(hex: "5120e4d810fd50586274face62b8a807eb9719cef49c04177cc6b76a9a4251d5450e")),
            Tx.Out(value: 630000000, scriptPubKeyData: Data(hex: "512091b64d5324723a985170e4dc5a0f84c041804f2cd12660fa5dec09fc21783605")),
            Tx.Out(value: 378000000, scriptPubKeyData: Data(hex: "00147dd65592d0ab2fe0d0257d571abf032cd9db93dc")),
            Tx.Out(value: 672000000, scriptPubKeyData: Data(hex: "512075169f4001aa68f15bbed28b218df1d0a62cbbcf1188c6665110c293c907b831")),
            Tx.Out(value: 546000000, scriptPubKeyData: Data(hex: "5120712447206d7a5238acc7ff53fbe94a3b64539ad291c7cdbc490b7577e4b17df5")),
            Tx.Out(value: 588000000, scriptPubKeyData: Data(hex: "512077e30a5522dd9f894c3f8b8bd4c4b2cf82ca7da8a3ea6a239655c39c050ab220"))
        ]
        ...
        _ = Tx(.init(hex: ""))
    }
}
