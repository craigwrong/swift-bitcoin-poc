...
final class ScriptTests: XCTestCase {
    ...
    func testOpSuccess() {
        ...
        stack = [Data]()
        XCTAssertThrowsError(try legacyScript.run(&stack))
        XCTAssertEqual(stack, [])
    }
    ...
    func testCheckSig() {
        ...
        let previousOutput = Output(value: 0, script: .init(Data(hex: "76a914786890276a55f3e6d2f403e3d595b6603964fa0d88ac")))
